...
<body data-kt-name="metronic" id="kt_body"
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex justify-content-center align-items-center flex-column flex-column-fluid flex-lg-row">
            <!--begin::Body-->
            <div class="py-20 shadow-lg w-400px"
                ...
                <form class="form w-100" method="POST" action="{{ route('login.login-proses') }}">
                    ...
                    <div class="text-center mb-11">
                        <!--begin::Aside-->
                        <!--begin::Logo-->
                        <img alt="Logo" class="mb-5" style="width: 100px" src="logo.png" />
                        <!--end::Logo-->
                        <!--begin::Aside-->
                        <!--begin::Subtitle-->
                        <div class="fw-semibold fs-6 text-white">PT. DUNIA LINTAS MANDIRI</div>
                        <!--end::Subtitle=-->
                        <!--begin::Title-->
                            ...
                            <div class="position-relative mb-3">
                                <div class="position-relative">
                                    ...
                                    <span
                                        ...
                                        <i class="bi bi-eye-slasimage-background image-backgroundh fs-2"></i>

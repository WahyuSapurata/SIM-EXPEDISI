                            ...
                            <div class="py-5 table-responsive">
                                <table id="kt_table_data"
                                    ...
                                    <tfoot class="bg-primary rounded">
                                        <tr class="fw-bolder fs-6 text-gray-800">
                                            <td style="text-align: left !important;" colspan="7">Total Piutang</td>
    ...
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'update') {
                ...
                control.submitFormMultipartData('/admin/update-piutang/' + uuid,
                    'Update',
                    'Piutang', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-piutang/' + $(this).attr('data-uuid');

            $('#terbayarkan').val('');
            $("#from_select").val(null).trigger("change");

            $(".title_side_form").html(`Update Piutang`);
            $(".text-danger").html("");
        ...
        $(document).on('click', '#button-cetak', function(e) {
            ...
            window.open(`/admin/print-piutang/` + uuid);
        });
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                columns: [{
                    ...
                    className: 'text-center',
                    render: function(data, type, row, meta) {
                        return data ? 'Rp ' + numeral(row.piutang - row.terbayarkan).format(
                            '0,0') : '-';
                    }
                }, {
                    data: 'status',
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    api.column(7, {
                        ...
                        total += parseFloat(value.piutang) - parseFloat(value.terbayarkan || 0);
                    });
        ...
        $(function() {
            control.push_select3(lunas, '#from_select');
            initDatatable();
        });
    </script>
@endsection

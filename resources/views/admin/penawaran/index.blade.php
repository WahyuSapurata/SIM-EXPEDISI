            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_costumer" class="form-control" name="nama_costumer">
                        <small class="text-danger nama_costumer_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="jenis_barang" class="form-control" name="jenis_barang">
                        <small class="text-danger jenis_barang_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        <label class="form-label">Lokasi Muat</label>
                        <input type="text" id="lokasi_muat" class="form-control" name="lokasi_muat">
                        <small class="text-danger lokasi_muat_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Lokasi Tujuan</label>
                        <input type="text" id="lokasi_tujuan" class="form-control" name="lokasi_tujuan">
                        <small class="text-danger lokasi_tujuan_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        <label class="form-label">Lokasi Pembuatan Surat</label>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Penawaran');
        });
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-penawaran', 'Tambah',
                    'Penawaran',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-penawaran/' + uuid,
                    'Update',
                    'Penawaran', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-penawaran/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Penawaran', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-penawaran/' + $(this).attr('data-uuid');
        ...
        $(document).on('click', '#button-cetak', function(e) {
            ...
            window.open(`/admin/print-penawaran/` + uuid);
        });
            ...
            $('#kt_table_data').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Penawaran" id="button-cetak" class="btn btn-warning btn-icon btn-sm">
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Penawaran" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">

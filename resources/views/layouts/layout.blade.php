                        ...
                        <a href="" class="full-logo">
                            <div class="app-sidebar-logo-default">
                                <div class="d-flex align-items-center gap-2">
                                    <img alt="Logo" src="{{ asset('logo.png') }}" class="w-45px h-sm-auto" />
                                    <div
                                        style="color: #ffffff; font-style: italic; font-weight: bolder; font-family: 'Arial', sans-serif;">
                                        PT. DUNIA LINTAS
                                        MANDIRI</div>
                                </div>
                            </div>
                            ...
                            <div class="app-sidebar-logo-minimize">
                                <img alt="Logo" src="{{ asset('logo.png') }}" class="h-15px " />
                            </div>
                        </a>
                    </div>

            ...
            <div class="d-flex flex-column flex-center text-center p-5">
                ...
                <div class="card card-flush w-lg-650px">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="fw-semibold fs-6 text-gray-500 mb-7">Maaf halaman tidak dapat di akses.!
                        </div>
                        <!--end::Text-->
                        <!--begin::Illustration-->
                        <div class="mb-11">
                            <img src="admin/assets/media/auth/500-error.png" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="admin/assets/media/auth/500-error-dark.png"
                                class="mw-100 mh-300px theme-dark-show" alt="" />
                        </div>
                        <!--end::Illustration-->
                        <!--begin::Link-->
                        <div class="mb-0">
                            <a href="javascript:history.back()" class="btn btn-sm btn-primary">Kembali ke halaman
                                semula</a>
                        </div>
                        <!--end::Link-->
                    </div>
